...
/**
 * WebMvcTest loads a simplified web environment for the tests. Note that the
 * normal
 * auto-discovery of beans (and dependency injection) is limited
 * This strategy deploys the required components to a test-friendly web
 * framework, that can be accessed
